...
@st.cache_resource
def load_model():
    return joblib.load(r"D:\nti crativa\test\models2_final_note\best_model_Random_Forest.pkl")
...
# ===============================
    ...
    col2.metric("Test Accuracy", "97.70%")
...
# ===============================
    ...
    try:
        with open(r"D:\nti crativa\test\models2_final_note\deployment_report.txt", "r", encoding="utf-8") as f:
            report = f.read()
